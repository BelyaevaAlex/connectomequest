...
The guarantees require a trusted receipt issuer, complete retained-plan
dependencies, and declared update semantics; they neither authenticate
cryptographically nor detect a systematically wrong issuer. Selective and
complete retained-plan validation are equivalent under
Proposition~\ref{prop:receipt-next-action}, but neither need match global
replanning after an unrelated world change.
